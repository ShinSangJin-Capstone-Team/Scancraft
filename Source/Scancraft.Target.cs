...
public class ScancraftTarget : TargetRules
{
	public ScancraftTarget(TargetInfo Target) : base(Target)
	{
        ...
        ExtraModuleNames.AddRange(new string[] { "Scancraft", "Open3DUE5", "Voxel" });
        //bUsePCHFiles = false;
